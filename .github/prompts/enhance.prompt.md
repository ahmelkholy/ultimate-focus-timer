...
- review all code C:\Users\ahm_e\AppData\Local\focus\scripts
- any changes make it in the same file no need any new files just modify the existing files
- make it pro reliable
